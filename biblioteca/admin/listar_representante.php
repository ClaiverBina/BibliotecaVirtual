  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <?php
            require_once 'Representantes/listarRepresentante.php';
            $all_representante = listarRepresentante();
            $total_representante = count($all_representante);
            echo $total_representante." Encontrados";
        ?>
        <!-- /.container-fluid -->
		<table class="table">
			<thead>
			...
			<tbody>
                        <?php
                            foreach ($all_representante as $dados) {
                        ?>    
			<tr>
				
				<td><?php echo $dados->login_representante_grupo; ?></td>
				<td><?php echo $dados->email_representante_grupo; ?></td>
				<td><?php echo $dados->curso_representante_grupo; ?></td>
				<td><?php echo $dados->status_representante_grupo; ?></td>
                                <td><a href="editar_representante.php?id_representante=<?php echo $dados->id_grupo; ?>" class="btn btn-primary">Alterar</a></td>
			</tr>
                        <?php } ?>
			</tbody>
		</table>
