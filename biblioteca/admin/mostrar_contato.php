...
<head>
  ...
  <title>Área Administrativa - Contato</title>
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- /.container-fluid -->
		<?php 
			require_once 'Tcc/listarContatoSelecionado.php';
			$all_contato = listarContatoSelecionado();
			foreach($all_contato as $dados){
		?>
		<div class="container">
			<h2 class="text-center">Assunto: <?php echo $dados->assunto_contato;?></h2>
			<hr/>
			<br/>
			<h6 class="text-center">Nome: <?php echo $dados->nome_contato;?></h6>
			<h6 class="text-center">Telefone: <?php echo $dados->telefone_contato;?></h6>
			<h6 class="text-center">Email: <?php echo $dados->email_contato;?></h6>
			<h6 class="text-center">Data: <?php echo date('d-m-Y', strtotime($dados->data_contato));?></h6>
			<br/>
			<br/>
			<div style="border: 1px solid black; padding: 10px; text-align:justify;"><?php echo $dados->mensagem_contato;?></div>
			<?php }?>
