        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div class="container col-sm-8">
                    <div class='div-msg msg-bg-erro-index'>
			<p><?php echo $msg_sucesso?></p>
		</div>
			<div class="div-logar">	
				<a href="javascript:history.back(1)">
					<button class="btn-msg"><p class="a-btn-msg">Voltar</p></button>
				</a>
			...
			<div>
				<a href="javascript:history.back(1)"> 
					<button class="voltar" style="margin:  190px 0 0 -520px; position: relative; float: left;">Voltar</button>
				</a>
			</div>
                </div>
