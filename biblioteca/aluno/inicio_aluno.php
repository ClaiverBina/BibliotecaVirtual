                ...
                <div id="content">
                    ...
                    <div class="container">
                        ...
                        <div class="img container col-sm-6">
                            <img src="../index/assets/img/info.png" alt="">

                            <img src="../index/assets/img/rh.png" alt="">


                            <img src="../index/assets/img/st.png" alt="">

                        </div>
                        <div class="img container col-sm-4">
                            <img src="../index/assets/img/cont.png" alt="">

                            <img src="../index/assets/img/adm.png" alt="">
                        </div>

                        <br/><br/>
                        <h2 class="text-center">Mas aonde é que eu estou?</h1>
                            <p class="text-center">Aqui é a área do aluno, uma seção separada do resto do site reservada para alunos</p>
                            <br/><br/>

                            <h2 class="text-center">O que eu faço aqui?</h1>
                                <p class="text-center">Faça upload do seu Trabalho de Conclusão de Curso (TCC) pela página de upload<br/>
                                    Ou veja as informações e a situação do TCC que você já mandou. </p>
                                <br/><br/>

                                <h2 class="text-center">Como eu saio?</h1>
                                    <p class="text-center">Clica no logout</p>
