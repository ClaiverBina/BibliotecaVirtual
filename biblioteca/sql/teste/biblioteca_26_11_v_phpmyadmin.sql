...
--
-- Host: 127.0.0.1
-- Generation Time: 26-Nov-2019 às 21:39
...
(7, 'Administração', 'Administração TesteAdministração TesteAdministração TesteAdministração TesteAdministração Teste', 'administracao.png', 'ATIVO');
...
--
ALTER TABLE `tb_tcc`
  MODIFY `id_tcc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
